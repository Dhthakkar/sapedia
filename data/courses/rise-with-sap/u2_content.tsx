  ...
  topics: [
    {
      ...
      question: {
        q: "Which three groups must collaborate robustly to achieve implementation project goals? (Select 3)",
        type: "multi",
        count: 3,
        options: ["Customer project team", "Implementation partners", "SAP experts", "Legal department"],
        correct: [0, 1, 2],
    ...
    },
    {
      ...
      question: {
        q: "Which additional SAP service offerings are available to complement customer transformation projects? (Select 2)",
        type: "multi",
        count: 2,
        options: ["SAP Preferred Success", "SAP MaxAttention", "SAP Basic Support only", "Third-party insurance"],
        correct: [0, 1],
