  ...
  topics: [
    {
      ...
      questions: [
        ...
        {
          q: "Why do custom programs in legacy ECC systems present a problem for businesses?",
          type: "single",
          options: ["They increase the hardware requirements", "They make every future upgrade harder and more complex", "They are too expensive to license", "They reduce the number of users allowed"],
          correct: [1],
          why: "Custom programs create a 'dirty' core, making it increasingly difficult to apply modern SAP updates."
        }
      ]
    },
    {
      ...
      questions: [
        ...
        {
          q: "Which solution handles 'Core Operations' like Finance and Manufacturing within the Suite?",
          type: "single",
          options: ["SAP BTP", "SAP SuccessFactors", "SAP S/4HANA", "SAP Ariba"],
          correct: [2],
          why: "S/4HANA is the digital core handling all critical business operations."
        }
      ]
    },
    {
      ...
      questions: [
        {
          q: "Which two are explicitly listed as IT challenges SAP addresses? (Select 2)",
          type: "multi",
          count: 2,
...
export const u1l2Content = {
  ...
  topics: [
    ...
    },
    {
      ...
      questions: [
        {
          q: "According to SAP, the transformation journey hinges on which three elements? (Select 3)",
          type: "multi",
          count: 3,
          options: ["People", "Processes", "Tools", "Technology"],
          correct: [0, 1, 2],
    ...
    },
    {
      ...
      questions: [
        {
          q: "Which three are the core components of the RISE with SAP Methodology? (Select 3)",
          type: "multi",
          count: 3,
          options: ["Standardised Framework", "Expert Guidance", "Integrated Toolchain", "Best Practices"],
          correct: [0, 1, 2],
...
export const u1l3Content = {
  ...
  topics: [
    ...
    },
    {
      ...
      questions: [
        {
          q: "Which three are official characteristics of a clean core system? (Select 3)",
          type: "multi",
          count: 3,
          options: ["Minimalism", "Scalability", "Maintainability", "Complexities"],
          correct: [0, 1, 2],
